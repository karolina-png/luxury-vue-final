                ...
                <carbody>
                    <div id="container_carbody">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr v-for="(a, index) in sales.articles">
                                    <td>{{a.name}}</td>

                                    <td>${{a.price}}</td>
                                    <td>{{a.code}}</td>
                                    <td><span @click="restar(a)"><i class="bi bi-file-minus-fill"></i></span>
                                        <span>{{a.amount}}</span>
                                        <span @click="sumar(a)"><i class="bi bi-file-plus-fill"></i></span>
                                    </td>

                                    <td>${{a.total}}</td>

                                    <td>
                                        <span @click="eliminar(index)"><i class="bi bi-trash"></i></span>
                                    </td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            insert(a) {
                let item = this.sales.articles
                    .find((art) => art.id == a.id);
                console.log(item)
                if (item == undefined) {
